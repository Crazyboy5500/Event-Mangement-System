          ...
          <div className="absolute z-10 mt-64 flex flex-col w-48 bg-white right-2 md:right-[160px] rounded-lg shadow-lg">
            <nav className={`block ${isMenuOpen ? 'block' : 'hidden'}`}>
              <div className="flex flex-col font-semibold text-[16px]">
                {user?.role === 'admin' && (
                  <>
                    <Link className="flex hover:bg-background hover:shadow py-2 pt-3 pl-6 pr-8 rounded-lg" to={'/dashboard'}>
                      Dashboard
                    </Link>
                    <Link className="flex hover:bg-background hover:shadow py-2 pl-6 pr-8 rounded-lg" to={'/createEvent'}>
                      Create Event
                    </Link>
                  </>
                )}
